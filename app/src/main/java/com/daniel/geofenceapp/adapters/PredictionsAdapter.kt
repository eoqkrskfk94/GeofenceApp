...
import com.daniel.geofenceapp.databinding.PredictionRowLayoutBinding
...
class PredictionsAdapter: RecyclerView.Adapter<PredictionsAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(val binding : PredictionRowLayoutBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        companion object{
            fun from(parent: ViewGroup): MyViewHolder {
                ...
                val binding = PredictionRowLayoutBinding.inflate(layoutInflater, parent, false)
